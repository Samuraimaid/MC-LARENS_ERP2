...
# Las 4 Gamas Oficiales de Polarizados (Ordenadas de más económica a la izquierda a más premium a la derecha)
TINT_GAMAS = [
    {
        "id": "gama_economica",
        "name": "Gama Económica",
        ...
        "description": "Línea accesible con excelente privacidad y protección solar estándar (Q1, Raybar 60\").",
    },
    {
        "id": "tinmax",
        "name": "Tinmax",
        ...
        "description": "Equilibrio ideal: Smoke, Charcoal, Raybar 40\", 3M y Quantum Regular.",
    },
    {
        "id": "nano_ceramico",
        "name": "Nano Cerámico",
        ...
        "description": "Rechazo térmico superior (hasta 90% IR), nitidez óptica y confort total (Supreme, Solstice).",
    },
    {
        "id": "gama_premium",
        "name": "Gama Premium",
        "order": 4,
        "badge_color": "bg-amber-500 text-black font-black",
        "border_color": "border-amber-500",
        "description": "Sputtered Quantum Original y Endeavor de alta gama para máxima durabilidad.",
    },
]
...
DEFAULT_TINT_WINDOW_MATERIALS_POLICY = {
    ...
    "materials": [
        # ==============================================================================
        # GAMA 1: GAMA ECONÓMICA (Izquierda)
        # ==============================================================================
        {
            "id": "q1_05_40",
            "name": "Q1 5%-40\"",
            ...
            "warranty_years": {"regular": 1, "original": 2},
            "is_active": True,
            "price_by_zone_group": {"windshield": 0.0, "sides": 0.0, "rear": 0.0},
            "rolls": {
                "windshield_under_40": {"sku": "ROLL-Q1-05-W40", "virtual_qty": 40, "is_available": True, "qty_per_job": 1.0},
                "windshield_over_40": {"sku": "ROLL-Q1-05-W40", "virtual_qty": 40, "is_available": True, "qty_per_job": 1.0},
                "side_under_20": {"sku": "ROLL-Q1-05-S40", "virtual_qty": 40, "is_available": True, "qty_per_job": 1.0},
                "side_over_20": {"sku": "ROLL-Q1-05-S40", "virtual_qty": 40, "is_available": True, "qty_per_job": 1.0},
            },
        },
        {
            "id": "q1_20_40",
            ...
            "price_by_zone_group": {"windshield": 0.0, "sides": 0.0, "rear": 0.0},
            "rolls": {
                "windshield_under_40": {"sku": "ROLL-Q1-20-W40", "virtual_qty": 40, "is_available": True, "qty_per_job": 1.0},
                "windshield_over_40": {"sku": "ROLL-Q1-20-W40", "virtual_qty": 40, "is_available": True, "qty_per_job": 1.0},
                "side_under_20": {"sku": "ROLL-Q1-20-S40", "virtual_qty": 40, "is_available": True, "qty_per_job": 1.0},
                "side_over_20": {"sku": "ROLL-Q1-20-S40", "virtual_qty": 40, "is_available": True, "qty_per_job": 1.0},
            },
        },
        {
            "id": "raybar_05_60",
            ...
            "price_by_zone_group": {"windshield": 0.0, "sides": 0.0, "rear": 0.0},
            "rolls": {
                "windshield_under_40": {"sku": "ROLL-RB-05-W60", "virtual_qty": 30, "is_available": True, "qty_per_job": 1.0},
                "windshield_over_40": {"sku": "ROLL-RB-05-W60", "virtual_qty": 30, "is_available": True, "qty_per_job": 1.0},
                "side_under_20": {"sku": "ROLL-RB-05-W60", "virtual_qty": 30, "is_available": True, "qty_per_job": 1.0},
                "side_over_20": {"sku": "ROLL-RB-05-W60", "virtual_qty": 30, "is_available": True, "qty_per_job": 1.0},
            },
        },

        # ==============================================================================
        # GAMA 2: TINMAX (Centro Izquierda)
        # ==============================================================================
        {
            "id": "std_05",
            "name": "Smoke 5%-20\"",
        ...
        },
        {
            ...
            "rolls": {
                ...
                "side_under_20": {"sku": "ROLL-RB-05-S40", "virtual_qty": 40, "is_available": True, "qty_per_job": 1.0},
                "side_over_20": {"sku": "ROLL-RB-05-S40", "virtual_qty": 40, "is_available": True, "qty_per_job": 1.0},
            },
        },
        {
        ...
        },
        {
            ...
            "rolls": {
                ...
                "side_under_20": {"sku": "ROLL-CRB-22-S20", "virtual_qty": 40, "is_available": True, "qty_per_job": 1.0},
                "side_over_20": {"sku": "ROLL-CRB-22-S40", "virtual_qty": 30, "is_available": True, "qty_per_job": 1.0},
            },
        },
        {
            "id": "sg_charcoal_06",
        ...
        # ==============================================================================
        # GAMA 3: NANO CERÁMICO (Centro Derecha)
        # ==============================================================================
        {
            "id": "sg_supreme_04",
            "name": "Supreme 4%-20\"",
        ...
        },
        {
            ...
            "rolls": {
                ...
                "side_under_20": {"sku": "ROLL-SG-SUP-15-S30", "virtual_qty": 30, "is_available": True, "qty_per_job": 1.0},
        ...
        },
        {
            ...
            "rolls": {
                ...
                "side_under_20": {"sku": "ROLL-SG-SUP-30-S20", "virtual_qty": 30, "is_available": True, "qty_per_job": 1.0},
                "side_over_20": {"sku": "ROLL-SG-SUP-30-S40", "virtual_qty": 35, "is_available": True, "qty_per_job": 1.0},
            },
        },
        {
            "id": "sg_supreme_42",
...
def get_available_materials_for_zone(
    ...
    for mat in materials:
        ...
        available.append({
            ...
            "gama": mat.get("gama", "tinmax"),
            "gama_label": mat.get("gama_label", "Tinmax"),
            "gama_order": mat.get("gama_order", 2),
            "vlt": mat.get("vlt"),
