  ...
  return (
    <div className="p-6 space-y-6" data-testid="deliveries-page">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="font-heading text-2xl mb-1 font-bold tracking-tight md:mb-0 md:text-3xl">Entregas y Logística</h1>
          <p className="hidden text-muted-foreground md:block">Gestión de entregas a domicilio y monitoreo GPS de flota en tiempo real</p>
        </div>
